...
- [ ] **`CLAUDE.md`** đã setup theo template ở [02 — Train via Claude §Bước 2](02-train-agent-via-claude.md)
...
Nếu có câu hỏi không tìm thấy answer trong bộ tài liệu, xem mục "**Khi nào cần liên hệ support?**" cuối file [04 — Troubleshooting](04-troubleshooting.md) để biết cách gom thông tin gửi support nhanh nhất.
