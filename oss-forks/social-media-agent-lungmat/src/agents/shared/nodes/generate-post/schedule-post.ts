...
import { isLungmatWebhookOnly } from "../../../../lungmat/config.js";
import { schedulePostLungmat } from "../../../../lungmat/schedule-lungmat.js";
...
>(state: State, config: LangGraphRunnableConfig): Promise<Update> {
  ...
  if (isLungmatWebhookOnly()) {
    return schedulePostLungmat(state, config);
  }
